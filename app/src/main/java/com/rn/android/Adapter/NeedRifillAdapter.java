...
import com.rn.android.model.ModelNeedRifill;
import com.rn.android.model.NewModelNeedRifill;
 ...
 */
public class NeedRifillAdapter extends
        RecyclerView.Adapter<NeedRifillAdapter.ViewHolder> {

    private static final String TAG = NeedRifillAdapter.class.getSimpleName();


    private Context context;
    private List<NewModelNeedRifill> list;

    public NeedRifillAdapter(Context context, List<NewModelNeedRifill> list
    ) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.row_need_to_rifill, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ArrayList<ModelNeedRifill> item = list.get(position).getModelNeedRifillArrayList();
    ...
    private void showDialog(ArrayList<ModelNeedRifill> WillBeRefill) {
...
//This makes the dialog take up the full width
        ...
        for (int i = 0; i <WillBeRefill.size() ; i++) {
            ...
            if (WillBeRefill.get(i).isDisplayMobile()){
